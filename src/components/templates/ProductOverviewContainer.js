...
export default class ProductOverviewContainer extends React.Component {
    ...
    render() {
                ...
                <div class={class_def} >
                    <a href={a_product.heading}>
                        <div class="row inner-product-box">
                            ...
                            <img class="img_color_black" src={a_product.icon_source} width="80px"></img>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        let second_container = (
            <div class=" text-center p-5 align-items-center" style={{ backgroundColor: "#C0C0C0", color: "black" }}>
                <h1 class="text-center align-items-center" >Our Apps</h1>
                <div class="row product_row text-center my-5 align-items-center" >
        ...
        return (
            <div class="" style={{ backgroundColor: "#C0C0C0", color: "black" }}>
                {second_container}
            </div>
        );
    }
