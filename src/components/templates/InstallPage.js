...
<div>
    <div class="callout text-center">
        ...
        <a href="/server/touchAble428.pkg">
...
<div >
    <div class="callout text-center">
        ...
        <img src="/images/downloadedpkg.png" alt="downloadedpkg-icon" class="clipped-image" width="500"></img>
        <h4>Please double-click the package you just downloaded</h4>
        <h4>In the upcoming dialogs, just follow through</h4>
        <img src="/images/install01.png" alt="install1-icon" class="clipped-image" width="500"></img>
        <h4>Just click "Continue"</h4>
        <img src="/images/install02.png" alt="install2-icon" class="clipped-image" width="500"></img>
        <h4>Just click "Install"</h4>
        <img src="/images/install03.png" alt="install3-icon" class="clipped-image" width="500"></img>
        <h4>After clicking "Install" you will have to authorize the installation with an admin-password</h4>
        <img src="/images/install04.png" alt="install4-icon" class="clipped-image" width="500"></img>
        <h4>Installation is done, just click "Close"</h4>
        <h4>The server will start automatically
            <br></br>
            <img src="/images/touchAble.app.png" alt="touchAble.app-icon" class="app-icon" width="120"></img>
        </h4>
        <p></p>
        <div class="call">
...
<div>
    <div class="callout text-center">
        ...
        <img src="/images/touchAbleMenubarIcon.jpg" alt="touchAbleMB-icon" class="clipped-image" width="350"></img>
        <h4>Click the touchAble-icon in the menubar</h4>
        <img src="/images/install05.png" alt="scriptdialog" class="clipped-image" width="350"></img>
        <h4>Click "Install Script" or hit "Shift-Command-R"</h4>
        <h4>The Installation-Dialog pops up</h4>
        <img src="/images/scriptinstall3.png" alt="install4-icon" class="clipped-image" width="500"></img>
        <h4>Click on the triangle and the dialog shows you your instances of Live</h4>
        <img src="/images/scriptinstall4.png" alt="install4-icon" class="clipped-image" width="500"></img>
        <h4>Select the version of Live you want the scripts install into.</h4>
        <img src="/images/scriptinstall5.png" alt="install4-icon" class="clipped-image" width="500"></img>
        <h4>Click "Install"</h4>
        <img src="/images/scriptinstall6.png" alt="install4-icon" class="clipped-image" width="500"></img>
...
<div>
    <div class="callout text-center">
        ...
        <img src="/images/live01.png" alt="live" class="clipped-image" width="500"></img>
        <h4>Open Live's preferences</h4>
        <img src="/images/live02.png" alt="liveprefs" class="clipped-image" width="500"></img>
        ...
        <img src="/images/live03.png" alt="livequit" class="clipped-image" width="300"></img>
...
<div>
    <div class="callout text-center">
        ...
        <img src="/images/tap01.png" alt="tap-opening" class="clipped-image" width="500"></img>
        <img src="/images/tap03.png" alt="tap-opening3" class="clipped-image" width="500"></img>
        ...
        <img src="/images/connection01.png" alt="connections01" class="clipped-image" width="500"></img>
        ...
        <img src="/images/connection02.png" alt="connections02" class="clipped-image" width="500"></img>
        <div class="call">
        ...
        <img src="/images/install05.png" alt="numberofconnections" class="clipped-image" width="300"></img>
        ...
        <img src="/images/connection03.png" alt="connections03" class="clipped-image" width="500"></img>
